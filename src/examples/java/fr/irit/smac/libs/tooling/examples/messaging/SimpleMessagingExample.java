...
public class SimpleMessagingExample {
	...
	public static void main(String[] args) {
		...
		IMsgBox<String> msgBox1 = AgentMessaging.getMsgBox("agent1",
				String.class);
		IMsgBox<String> msgBox2 = AgentMessaging.getMsgBox("agent2",
				String.class);
		...
		System.out.println("msgBox2 size after consultation : "
				+ msgBox2.getMsgs().size());
